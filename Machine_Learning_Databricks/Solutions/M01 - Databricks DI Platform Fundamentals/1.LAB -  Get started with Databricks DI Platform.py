...
# MAGIC GRANT MODIFY ON TABLE customer_demographics TO `account users`;
...
# MAGIC SHOW GRANTS ON TABLE customer_demographics ;
...
# MAGIC REVOKE MODIFY ON TABLE customer_demographics FROM `account users`;
